/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv ./cloudflare-env.d.ts` (hash: 47c06cf8fd1bcb37c2a62ca675a09b37)
// Runtime types generated with workerd@1.20260721.1 2026-07-17 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	DB: D1Database;
	IMAGES: ImagesBinding;
	ASSETS: Fetcher;
	ACCESS_SERVICE_TOKEN_CN?: "fe2d68d9fa57529df430962a8f984970.access";
	ACCESS_SERVICE_ACCOUNT_EMAIL?: "e2e-bot@excel-capital.invalid";
	...
	APP_BASE_URL: string;
	SETUP_LINK_SIGNING_SECRET: string;
	...
	BORROWER_PAYMENT_COORDINATOR: DurableObjectNamespace<import("./worker").BorrowerPaymentCoordinator>;
	WORKER_SELF_REFERENCE: Fetcher /* excel-capital-vrp-staging */ | Fetcher /* excel-capital-vrp-prod */ | Service<typeof import("./worker").default>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker");
		durableNamespaces: "BorrowerPaymentCoordinator";
	}
	interface StagingEnv {
		...
		PLAID_CONSENT_TYPE: string;
		BORROWER_PAYMENT_COORDINATOR: DurableObjectNamespace<import("./worker").BorrowerPaymentCoordinator>;
		WORKER_SELF_REFERENCE: Fetcher /* excel-capital-vrp-staging */;
	}
	interface ProductionEnv {
		...
		PLAID_CONSENT_TYPE: string;
		BORROWER_PAYMENT_COORDINATOR: DurableObjectNamespace<import("./worker").BorrowerPaymentCoordinator>;
		WORKER_SELF_REFERENCE: Fetcher /* excel-capital-vrp-prod */;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ACCESS_SERVICE_TOKEN_CN" | "ACCESS_SERVICE_ACCOUNT_EMAIL" | "STAFF_AUTO_PROVISION_DOMAIN" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_API_TOKEN" | "R2_ACCESS_KEY_ID" | "R2_SECRET_ACCESS_KEY" | "R2_S3_ENDPOINT" | "PLAID_ENV" | "PLAID_WEBHOOK_URL" | "APP_BASE_URL" | "SETUP_LINK_SIGNING_SECRET" | "APP_ENCRYPTION_KEY" | "CRON_SECRET" | "ACCESS_TEAM_DOMAIN" | "ACCESS_AUD" | "STAFF_BOOTSTRAP_ADMINS" | "RESEND_API_KEY" | "EMAIL_FROM" | "PLAID_SCOPE" | "APP_ENV" | "PLAID_CLIENT_ID" | "PLAID_SECRET" | "COLLECTIONS_ENABLED" | "PLAID_CONSENT_TYPE">> {}
}
